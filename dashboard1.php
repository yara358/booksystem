<!--This code to  offerr the manager the dashbord for all of his activities  -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Best books in books land</title>
...
<div class="row"><!-- row no: 2 begin -->
    ...
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            ...
            <a href="best_sales.php"><!-- a href begin -->
        ...
        <div class="panel panel-success"><!-- panel panel-green begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> our </div>
                           
                        <div> Best Authors </div>
            ...
            <a href="best_authors.php"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->
    ...
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-danger"><!-- panel panel-red begin -->
            ...
            <a href="category_list.php"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->
...
<div class="row"><!-- row no: 3 begin -->
    <div class="col-lg-5"><!-- col-lg-8 begin -->
        <div class="panel panel-info"><!-- panel panel-dark begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->

                <i class="fa fa-money fa-fw"></i> New Sales
            ...
            <div class="text-right"><!-- text-right begin -->
                    ...
                    <a href="NewSales.php"><!-- a href begin -->
    ...
    <div class="col-lg-5"><!-- col-lg-8 begin -->
        <div class="panel panel-info"><!-- panel panel-dark begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                ...
                <i class="fa fa-money fa-fw"></i> New Books
            ...
            <div class="text-right"><!-- text-right begin -->
                    ...
                    <a href="NewSales.php"><!-- a href begin -->
                        ...
                        View All New books  <i class="fa fa-arrow-circle-right"></i>
